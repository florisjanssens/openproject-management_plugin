...
describe UsersController, type: :routing do
  describe 'csv_import' do
    it do
      expect(get('bulk/import')).to route_to(
        controller: 'users',
        action: 'csv_import'
      )
    end
  ...
  describe 'csv_import_tutorial' do
    it do
      expect(get('bulk/import_tutorial')).to route_to(
        controller: 'users',
        action: 'csv_import_tutorial'
      )
    end
  end
  ...
  describe 'csv_import_submit' do
    it do
      expect(post('bulk/import_submit')).to route_to(
        controller: 'users',
        action: 'csv_import_submit'
      )
    end
  end
end

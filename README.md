...
[![Build Status](https://travis-ci.com/florisjanssens/openproject-management_plugin.svg?token=Rqy6tmTtqW4aahqT8zzP&branch=release/10.6.0)](https://travis-ci.com/florisjanssens/openproject-management_plugin)
...
## Requirements
This plugin has no requirements on top of the requirements of version 10.6.0 of the [OpenProject Core](https://github.com/opf/openproject/).
